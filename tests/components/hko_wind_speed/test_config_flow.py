"""Test the Hong Kong Observatory [Wind Speed] config flow."""

from unittest.mock import patch

from homeassistant.components.hko_wind_speed.const import DEFAULT_LOCATION, DOMAIN
from homeassistant.components.hko_wind_speed.coordinator import HKOWSError
...
async def test_config_flow_cannot_connect(hass: HomeAssistant) -> None:
    ...
    with patch(
        ...
        client_mock.side_effect = HKOWSError()
        result = await hass.config_entries.flow.async_init(
            DOMAIN,
