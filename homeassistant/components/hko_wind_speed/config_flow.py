"""Config flow for Hong Kong Observatory [Wind Speed] integration."""
...
from .const import DEFAULT_LOCATION, DOMAIN, KEY_LOCATION, LOCATIONS
from .coordinator import HKOWS, HKOWSError
...
class HKOWSConfigFlow(ConfigFlow, domain=DOMAIN):
